...
Answer in under 180 words unless asked for depth. When helpful, include a JSON object with a "resources" array (title, url, source).
Example:
{ "resources": [ { "title": "21 CFR Part 11", "url": "https://www.ecfr.gov/" } ] }
