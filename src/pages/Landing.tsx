  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <p className="text-neutral-300 mb-6">
        An AI learning assistant for pharmaceutical Quality & Compliance. Ask questions,
        learn faster, and collect a 30‑day history in your Notebook.
      </p>
      ...
      <div className="mt-8">
        <a href="/app" className="px-4 py-3 bg-blue-600 rounded-lg">Open the app</a>
      </div>
    </div>
  );
}
